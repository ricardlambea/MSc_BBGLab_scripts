# Script used to calculate the adjusted Pvalue of the expression data by FDR method, and in this special case, retain the genes that have  a adjusted p-value greater than 0.05. This script takes as first argument the file name of the DESeq2 outfile file, and as second argument the file name of the output that will be generated.
